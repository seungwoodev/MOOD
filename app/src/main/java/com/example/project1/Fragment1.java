...
//        contactRVAdapter = new SimpleTextAdapter(contactsModalArrayList);
//        //on below line we are setting layout mnager.
...
//                            // do you work now
//                            getContacts();
//                            Toast.makeText(com.gtappdevelopers.gfgparse.Tab1MainActivity.this, "All the permissions are granted..", Toast.LENGTH_SHORT).show();
//                        }
...
//        // we are displaying an alert dialog for permissions
//        AlertDialog.Builder builder = new AlertDialog.Builder(com.gtappdevelopers.gfgparse.Tab1MainActivity.this);
//
